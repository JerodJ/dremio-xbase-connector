...
@SourceType(value = "xBaseARP", label = "xBase",uiConfig = "xbase-layout.json")
public class xBaseConf extends AbstractArpConf<xBaseConf> {
  private static final String ARP_FILENAME = "arp/implementation/xbase-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.xbase.xBaseDriver";
